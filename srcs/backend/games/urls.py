...
from .views.recovery_views import CheckActiveMatchAPIView, CheckActiveTournamentAPIView
...
urlpatterns = [
    ...
    path('check-active-tournament/', CheckActiveTournamentAPIView.as_view(), name='check-active-tournament')
]
